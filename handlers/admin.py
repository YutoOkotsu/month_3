...
BAD_WORDS = ("дурак", "тупой", "сука", "блять", "нахуй", "хуй", "пизда", "ебать", "даун", "заебал")


@admin_router.message(Command("ban", prefix="/!", magic=True))
@admin_router.message(F.chat.type == "group")
...
@admin_router.message((F.chat.type == "group") & (F.text))
